...
@NgModule({
  declarations: [ManageScreenOperationComponent, ManageScreenOperationPresentationComponent],
  imports: [CommonModule, ScreenOperationRoutingModule, MatSlideToggleModule, ReactiveFormsModule, SharedModule],
})
