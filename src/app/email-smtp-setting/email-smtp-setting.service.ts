...
export class EmailSmtpSettingService {
  ...
  getEmailSMTPSettings(): Observable<EmailSMTPSetting[] | CommonError> {
    ...
    return this.httpClient.get<EmailSMTPSetting[]>(url).pipe(catchError(this.commonHttpErrorService.handleError))
  }
  ...
  updateEmailSMTPSetting(setting: EmailSMTPSetting): Observable<EmailSMTPSetting | CommonError> {
    ...
    return this.httpClient.put<EmailSMTPSetting>(url, setting).pipe(catchError(this.commonHttpErrorService.handleError))
  }

  deleteEmailSMTPSetting(id: string): Observable<EmailSMTPSetting | CommonError> {
    const url = `EmailSMTPSetting/${id}`
    return this.httpClient.delete<EmailSMTPSetting>(url).pipe(catchError(this.commonHttpErrorService.handleError))
  }
}
