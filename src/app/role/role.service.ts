...
export class RoleService {
  ...
  updateRole(role: Role): Observable<Role | CommonError> {
    ...
    return this.httpClient.put<Role>(url, role).pipe(catchError(this.commonHttpErrorService.handleError))
  }

  addRole(role: Role): Observable<Role | CommonError> {
    const url = `role`
    return this.httpClient.post<Role>(url, role).pipe(catchError(this.commonHttpErrorService.handleError))
  }
  ...
  getRoleUsers(id: string): Observable<UserRoles[] | CommonError> {
    ...
    return this.httpClient.get<UserRoles[]>(url).pipe(catchError(this.commonHttpErrorService.handleError))
  }
