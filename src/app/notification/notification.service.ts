...
export class NotificationService {
  ...
  getNotification(): Observable<UserNotification[] | CommonError> {
    ...
    return this.httpClient.get<UserNotification[]>(url).pipe(catchError(this.commonHttpErrorService.handleError))
  }
  ...
  markAsRead(id: string) {
    ...
    return this.httpClient.post<void>(url, { id }).pipe(catchError(this.commonHttpErrorService.handleError))
  }

  markAllAsRead() {
    const url = `UserNotification/MarkAllAsRead`
    return this.httpClient.post<void>(url, null).pipe(catchError(this.commonHttpErrorService.handleError))
  }
}
